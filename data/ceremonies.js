...
export const ceremonies = [
  {
    id: "hai-goer",
    order: 1,
    titleKhmer: "ពិធីហែជំនូន (ហែកូនកំលោះ)",
    titleEn: "Hai Goer Chomnoon — Groom's Morning Procession",
    phonetic: "Hai-Cher-Chom-Noon",
  ...
  },
  {
    id: "gaat-sah",
    order: 2,
    titleKhmer: "ពិធីកាត់សក់បង្កក់សិរី",
    titleEn: "Pithei Gaat Sah — Hair Cutting & Cleansing Ceremony",
    phonetic: "Pee-Tey Gaht Sah",
    ...
    steps: [
      {
        ...
        meaningKhmer: "សំណើចជួយបន្ធូរភាពតានតឹងរបស់គូស្វាមីភរិយា និងនាំមកនូវសិរីសួស្តីតាមរយៈភាពរីករាយ។"
      },
      {
        stepNumber: 2,
  ...
  },
  {
    id: "plerng-ka",
    order: 3,
    titleKhmer: "ពិធីសំពះផ្ទឹម និងតោងជាយស្បៃ",
    titleEn: "Pithei Plerng Ka / Sompeas Ptem — Nuptial Pair Union",
    phonetic: "Som-peah Ptem / Plerng-Kah",
  ...
  },
  {
    id: "bongvel-popil",
    order: 4,
    titleKhmer: "ពិធីបង្វិលពពិល",
    titleEn: "Pithei Bongvel Popil — Passing of the Sacred Candle Smoke",
    phonetic: "Bong-Vel Po-Pil",
  ...
  },
  {
    id: "chang-dai",
    order: 5,
    titleKhmer: "ពិធីចងដៃ (ចងអំបោះក្រហម)",
    titleEn: "Pithei Chang Dai — Tying the Red Thread & Knot Blessing",
    phonetic: "Pee-Tey Chang-Dai",
  ...
  },
  {
    id: "phat-phka-sla",
    order: 6,
    titleKhmer: "ពិធីបាចផ្កាស្លា និងចូលបន្ទប់ផ្សំដំណេក",
    titleEn: "Pithei Phat Phka Sla — Scattering Areca Flowers & Nuptial Chamber",
    phonetic: "Phat Phka Sla",
    ...
    steps: [
      {
        ...
        meaningKhmer: "ផ្កាស្លាជានិមិត្តរូបបុរាណនៃភាពបរិសុទ្ធ ភាពត្រជាក់ត្រជុំ និងការបន្តពូជពង្សវង្សត្រកូលប្រកបដោយសេចក្តីសុខ។"
      },
      {
        stepNumber: 2,
