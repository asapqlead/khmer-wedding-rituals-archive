      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <a href="#" className="link-text" style={{ fontSize: "13px" }}>
                  Forgot?
                </a>
              </div>
              <input
          ...
          <div style={{ marginTop: "28px", fontSize: "14px", color: "rgba(255, 255, 255, 0.7)", textAlign: "center" }}>
            Don't have an account? <Link href="/signup" className="link-text" style={{ fontWeight: "600", color: "#ffffff" }}>Sign up</Link>
          </div>
        </div>
      </main>
    </>
